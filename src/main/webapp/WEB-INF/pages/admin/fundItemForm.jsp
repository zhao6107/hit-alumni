...
<div style="padding-left: 20px;">
    ...
    <form action="${actionUrl}" method="post">
        ...
        基金类型：<select name="typeId" required="required" style="text-align: center;">
        <c:forEach items="${fundTypes}" var="fundType">
            <option value="${fundType.id}">${fundType.name}</option>
        </c:forEach>
        <%--<option value="1">特别基金</option>--%>
        <%--<option value="2">院系基金</option>--%>
    </select><br><br>
